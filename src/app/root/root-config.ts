...
export const ROOT_CONFIG = new InjectionToken<RootConfig>('ROOT_CONFIG');

export function createRootInitializer(document: Document, options?: RootConfig): () => void {
  return function rootInitializer(): void {
    if (options) {
